...
const MySlider = () => {
  ...
  return (
    <Slider {...settings} >
      ...
      <img height={"500px"} src="https://img.freepik.com/free-vector/chemistry-measuring-glass-tubes-beakers-realistic-vector-illustration-set-empty-transparent-filled-with-colored-liquid-laboratory-flasks-lab-test-equipment-science-glassware_107791-24023.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
      <img  height={"500px"} src="https://img.freepik.com/premium-photo/healthcare-professional-holding-coronavirus-covid19-vaccine-laboratory-study-analyze-scientific-sample-coronavirus-antibody_533890-3418.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph"/>
