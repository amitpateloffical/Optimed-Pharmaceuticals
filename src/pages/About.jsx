        ...
        <div className="container py-4">
          <div className="row g-2 align-items-center">
            <div className="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
              ...
              Optimed Pharmaceuticals: Advancing Healthcare through Innovation and Excellence
              </h3>
              <div className="paragraph_container ">
                <p className="paragraph fs-5 pt-2">
                Optimed Pharmaceuticals stands as a beacon of innovation and excellence in the 
                realm of healthcare. With a steadfast commitment to advancing medical science 
                and improving patient outcomes, Optimed spearheads groundbreaking research and development 
          ...
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/free-photo/pills-coming-out-jar_176474-1685.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
            <div
              className="col-lg-6 wow fadeIn"
              ...
              <div className="content_container">
                ...
                >
                  <li className="list-group-item" data-aos="fade-left">
                    ...
                    Optimed Pharmaceuticals pioneers innovative healthcare solutions.
                  </li>
                  <li className="list-group-item" data-aos="fade-left">
          ...
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h3 className="mb-4" data-aos="fade-right">
                By partnering with Optimed Pharmaceuticals, you can:
              </h3>
              <div className="content_container">
                <ul
                  className="list-group"
              ...
              >
                ...
                Contact Optimed Pharmaceuticals today to explore our innovative healthcare solutions.
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/premium-vector/pharmacological-business-abstract-concept-vector-illustration_107173-25943.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="aboutsimg">
                <img className="img-fluid" src="https://img.freepik.com/premium-photo/smiling-pharmacist-standing-counter-pharmacy_107420-58630.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              <div className="content_container">
                ...
                >
                  <li className="list-group-item" data-aos="fade-left">
                    <b> Global Impact: </b> Optimed Pharmaceuticals strives to make a meaningful impact on a global scale by improving access to healthcare and advancing medical science.
                  </li>
                  <li className="list-group-item" data-aos="fade-left">
                  ...
                  <li className="list-group-item" data-aos="fade-left">
                    <b>Community Engagement: </b> Committed to giving back to the community, Optimed Pharmaceuticals actively participates in philanthropic initiatives and supports healthcare initiatives in underserved regions.
                  </li>
      ...
      <div className="container-fluid py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/free-photo/laboratory-glassware-with-liquids-different-color_1150-19441.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container-fluid section2 py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/free-vector/biotechnology-isometric-composition-with-computer-screens-dna-pills-syringe-silhouette-human-body-projection-vector-illustration_1284-83231.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
